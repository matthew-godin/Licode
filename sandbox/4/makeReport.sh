...
(cat 4/stub.py) >> answer.py
(cat 4/stubCustomInput.py) >> answerCustomInput.py

containerID=$(docker run -dit py-sandbox)
docker cp 4/TestInputs/ ${containerID}:home/TestEnvironment/TestInputs/
docker cp 4/TestOutputs/ ${containerID}:home/TestEnvironment/TestOutputs/
...
docker cp 4/clean.py ${containerID}:home/TestEnvironment/clean.py
