...
(cat 8/stub.py) >> answer.py
(cat 8/stubCustomInput.py) >> answerCustomInput.py

containerID=$(docker run -dit py-sandbox)
docker cp 8/TestInputs/ ${containerID}:home/TestEnvironment/TestInputs/
docker cp 8/TestOutputs/ ${containerID}:home/TestEnvironment/TestOutputs/
...
docker cp 8/clean.py ${containerID}:home/TestEnvironment/clean.py
