...
(cat 6/stub.py) >> answer.py
(cat 6/stubCustomInput.py) >> answerCustomInput.py

containerID=$(docker run -dit py-sandbox)
docker cp 6/TestInputs/ ${containerID}:home/TestEnvironment/TestInputs/
docker cp 6/TestOutputs/ ${containerID}:home/TestEnvironment/TestOutputs/
...
docker cp 6/clean.py ${containerID}:home/TestEnvironment/clean.py
